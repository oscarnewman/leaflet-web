...
export const PlaceholderImage = (props: StyleProps) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 100 100"
		className="heroicon-home heroicon heroicons-lg"
		{...props}
	>
		<path
			className="heroicon-home-wall heroicon-component-fill"
			fill="#FFFFFF"
			d="M8 50L50 8l42 42v48H8V50zm10 7v22h12V57H18zm52 0v22h12V57H70zM50 38a8 8 0 1 0 0-16 8 8 0 0 0 0 16z"
		/>
		<polygon
		...
		<path
			...
			fill="#FFFFFF"
			d="M52 27v-3.71A7.01 7.01 0 0 1 56.71 28H52v-1zm-8.71 1A7.01 7.01 0 0 1 48 23.29V28h-4.71zM48 36.71A7.01 7.01 0 0 1 43.29 32H48v4.71zM56.71 32A7.01 7.01 0 0 1 52 36.71V32h4.71zM18 57h12v22H18V57zm52 0h12v22H70V57z"
		/>
		<polygon
			className="heroicon-home-parging heroicon-component-fill"
			fill="#FFFFFF"
			points="93 90 7 90 7 99 93 99"
		/>
		<path
			className="heroicon-shadows"
			fill="#000000"
			d="M7 50L50 7l43 43v6L50 13 7 56v-6zm7 33h20v2H14v-2zm52 0h20v2H66v-2z"
			opacity=".2"
		/>
		<path
